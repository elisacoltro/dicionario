function carregaDicionario() {
  ...
  //usa o for para atribuir a mesa regra para todos os objetos.+= é um operador de atribuição.
...
carregaDicionario(); //isso é a gente chamando a função. sem isso a função não funciona.
